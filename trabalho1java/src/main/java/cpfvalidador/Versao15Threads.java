...
public class Versao15Threads {
    private static final String ENTRADA_DIR = "entradas";
    ...
    public static void main(String[] args) throws Exception {{
        ...
        int arquivosPorThread = (int) Math.ceil(30.0 / 15);
        ...
        System.out.println("Versão 15 threads:");
        ...
        try (PrintWriter pw = new PrintWriter("versao_15_threads.txt")) {{
